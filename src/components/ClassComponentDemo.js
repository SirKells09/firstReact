    ...
    return (
        <div>
            ...
            <dl>
                ...
                <dd>Class components need to extend the react 
                Component </dd>
                <dt>render()</dt>
                <dd>Class components must aleays have a render method.</dd>
                <dt>export</dt>
                <dd>Ony one class component exported</dd>
            </dl>
        </div>
    );
};
